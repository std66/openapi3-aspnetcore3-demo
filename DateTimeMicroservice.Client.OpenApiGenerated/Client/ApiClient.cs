...
namespace DateTimeMicroservice.Client.OpenApiGenerated.Client
{
    /// <summary>
    ...
    public partial class ApiClient : ISynchronousClient, IAsynchronousClient
    {
        ...
        public ApiClient()
        {
            _baseUrl = DateTimeMicroservice.Client.OpenApiGenerated.Client.GlobalConfiguration.Instance.BasePath;
        }
